...
{
    public class ReserveARangeOfSeatsCommandHandler : IRequestHandler<ReserveARangeOfSeats, TicketEntity>
    {
        ...
        public async Task<TicketEntity> Handle(ReserveARangeOfSeats command, CancellationToken cancel)
        {
        ...
        private async Task<ShowtimeEntity> GetShowtimeIfExistsOrThrowException(ReserveARangeOfSeats command, CancellationToken cancel)
        {
